...
const   InsumosMoldesSiliconaCliente = () => {
                    ...
                    <div className="flex flex-row gap-6 mb-6 pt-5 md:grid-cols-2 font-bold">
                        ...
                        <h2 class="mb-2 text-3xl font-semibold text-gray-900 dark:text-white pt-14">Insumos</h2>
                            <ul class="space-y-1 max-w-md list-inside text-black dark:text-gray-400">
                                <li>
                                    <a href='/InsumosMoldesSiliconaCliente' class="font-medium  dark:text-blue-500 hover:underline text-1xl">Moldes de silicona</a>
                                    
                                </li>
                                <li>
                                <a href='/InsumosCortadoresCliente' class="font-medium  dark:text-blue-500 hover:underline text-1xl">
                                     Cortadores
                                </a>
                                   
                                </li>
                                <li>
                                <a href='/InsumosTonalizadoresCliente' class="font-medium  dark:text-blue-500 hover:underline text-1xl">Tonalizadores</a>
...
export default InsumosMoldesSiliconaCliente;
