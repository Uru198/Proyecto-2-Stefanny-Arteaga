...
const InicioAdmi = () => {
  ...
  <Avatar
    img="https://www.iconpacks.net/icons/2/free-user-icon-3297-thumb.png"
    status="online"
    rounded={true}
    bordered={true}
    color="success"
        ...
        <div class="container mx-center bg-amber-300 ">
                    ...
                    <div className="grid gap-6 mb-6 pt-5 md:grid-cols-2 font-bold ">
                        <div className="clear-left ml-10 mt-10 ">
                            <h1 className="text-6xl pt-44">Bienvenidos</h1>
                            <br/>
                    ...
                    <h1 className="text-6xl pt-44 fom">Cursos</h1>
                    <div className="h-[10px] sm:h-[90px] xl:h-[90px] 2xl:h-[600px] w-[1400px] ml-[80px]  ">
