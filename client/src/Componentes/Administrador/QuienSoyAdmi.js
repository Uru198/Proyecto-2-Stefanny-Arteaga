    ...
    return (
        ...
        <div class="bg-[url('../public/img/fondo.png')] ">
                <div className="bg-zinc-300 bg-opacity-80 pb-14 ">
                    <div className="flex flex-row gap-6 mb-[100px] pt-5 md:grid-cols-2 font-bold">
                        ...
                        <p className="text-left text-2xl w-[400px] pt-10 ">Hola soy stefanny arteaga 
                        ...
                        <div className="flex-col justify-center  bg-yellow-100 border-4  border-yellow-700 rounded-full shadow-xs  float-left">
                            <img  className=" w-[600px] transform scale-75 transition duration-300 ease-in-out rounded-full outline-2 outline-offset-2 pt-[70px]" src="img/header.jpg" alt=""/>
                        </div>
                    </div> 
                </div>
