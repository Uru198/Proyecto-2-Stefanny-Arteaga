...
const   ModeladoAnimales = () => {
    ...
    const borrarModelado = id => {
        axios.delete("http://localhost:8000/api/modelados/"+id, {withCredentials: true})
            .then(res => {
                //Actualizar ls lita de autores por medio de filter
                let nuevaLista = modelados.filter(modelado => modelado._id !== id);
                setModelados(nuevaLista);
            })
    }
    ...
    return (
        ...
        <div class="bg-[url('../public/img/fondo.png')]">
                ...
                <div class="flex  flex-row-reverse space-x-4 pt-4 pr-5">
                        <Link to="/NuevoModeladoInfantil" class="py-1 px-4  bg-[#3fff3b] text-white font-bold border-transparent border-2 border-black text-1 rounded-3xl hover:border-black hover:bg-[#80e67f] hover:text-black transition duration-200'" type="submit">
                                        Agregar modelado
                            </Link>
                </div>
                    <div className="flex flex-row gap-6 mb-6 pt-5 md:grid-cols-2 font-bold">
                        ...
                        <h2 class="mb-2 text-3xl font-semibold text-gray-900 dark:text-white pt-14">Modelados</h2>
                            <ul class="space-y-1 max-w-md list-inside text-black dark:text-gray-400">
                                <li>
                                    <a href='/ModeladoAnimales' class="font-medium  dark:text-blue-500 hover:underline text-1xl">Animales</a>
                                    
                                </li>
                                <li>
                                <a href='/ModeladoNovios' class="font-medium  dark:text-blue-500 hover:underline text-1xl">
                                     Novios
                                </a>
                                   
                                </li>
                                <li>
                                <a href='/modeladoInfantil' class="font-medium  dark:text-blue-500 hover:underline text-1xl">Infantil</a>
                        ...
                        <div className="clear-left ml-20 w-[350px] pb-10 mb-2 text-3xl font-semibold text-gray-900 dark:text-white">
                                <h3 className="text-5xl ">Animales</h3>
                            </div>
                            {modelados.map((modelado, index) => (
                                ...
                                <form class="flex-auto pl-6">
                                    ...
                                    <div class="flex space-x-4 pt-6">
                                        <button to={`/ActualizarModeladoInfantil/${modelado._id}`} class="py-1 px-4  bg-[#ffb41e] text-white font-bold border-transparent border-2 border-black text-1 rounded-3xl hover:border-black hover:bg-[#ffc85a] hover:text-black transition duration-200'" type="submit">
                                        Editar
                                        </button>
                                        <button  onClick={() => borrarModelado(modelado._id)} class="py-1 px-4  bg-[#cc2c2c] text-white font-bold border-transparent border-2 border-black text-1 rounded-3xl hover:border-black hover:bg-[#fc7676] hover:text-black transition duration-200'" type="submit">
                                        Borrar
                                        </button>
                                    </div>
...
export default ModeladoAnimales;
