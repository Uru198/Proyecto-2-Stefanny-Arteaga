...
const NuevoModeladoInfantil = () => {
    ...
    const guardarModelado = e => {
        e.preventDefault();
        axios.post("http://localhost:8000/api/modelados/new", {
            categoria,
            estilo,
            nombre_modelado,
            imagen,
                ...
                <div className="flex-col justify-center  bg-white  pr-100 pl-100 border-4 border-sky-500 rounded-xl ">
                    ...
                    <form onSubmit={guardarModelado}>
                        ...
                        <div className="container mx-auto px-20 h-5/6">
                            ...
                            <h1 className="text-4xl font-medium flex justify-center">Nuevo Modelado</h1>
                            <br/>
...
export default NuevoModeladoInfantil;
