                            ...
                            {modelados.map((modelado, index) => (
                                ...
                                <form class="flex-auto pl-6">
                                    ...
                                    <div class="flex space-x-4 pt-6">
                                        <Link to={`/ActualizarModeladoInfantil/${modelado._id}`} class="py-1 px-4  bg-[#ffb41e] text-white font-bold border-transparent border-2 border-black text-1 rounded-3xl hover:border-black hover:bg-[#ffc85a] hover:text-black transition duration-200'" type="submit">
                                        Editar
                                        </Link>
...
export default ModeladoInfantil;
