        ...
        <div class="bg-[url('../public/img/fondo.png')]">
                ...
                <div className="flex flex-row gap-6 mb-6 pt-5 md:grid-cols-2 font-bold">
                        ...
                        <div className="clear-left ml-20 w-[350px] pb-10 mb-2 text-3xl font-semibold text-gray-900 dark:text-white">
                                <h3 className="text-5xl ">Moldes de silicona</h3>
                            </div>
                            {insumos.map((insumo, index) =>  
                            {
                                
                                if(insumo.categoriaInsumos == "Moldes de silicona") {
                                    return  (
                                        <tr key={index}>
                                ...
                                <form class="flex-auto pl-6">
                                    ...
                                    <div class="relative flex flex-wrap items-baseline pb-6 before:bg-black before:absolute before:-top-6 before:bottom-0 before:-left-60 before:-right-6 w-[200px]">
                                    ...
                                    <div class="flex space-x-4 pt-6">
                                        <button to={`/ActualizarInsumoCortadores/${insumo._id}`} class="py-1 px-4  bg-[#ffb41e] text-white font-bold border-transparent border-2 border-black text-1 rounded-3xl hover:border-black hover:bg-[#ffc85a] hover:text-black transition duration-200'" type="submit">
                                        Editar
                                        </button>
                                        <button  onClick={() => borrarModelado(insumo._id)} class="py-1 px-4  bg-[#cc2c2c] text-white font-bold border-transparent border-2 border-black text-1 rounded-3xl hover:border-black hover:bg-[#fc7676] hover:text-black transition duration-200'" type="submit">
                                        Borrar
                                        </button>
                                    </div>
...
export default InsumoMoldesSilicona;
